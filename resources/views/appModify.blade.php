    ...
    <div class="ad-submit-wrap">
        <form method="post">
            ...
            <div class="form-group clearfix">
                ...
                <div class="col-md-10">
                    <input type="text" placeholder="名称" name="name" class="form-control" value="{{$info->name}}" id="info_1">
                </div>
            </div>
            <div class="form-group clearfix">
                <label for="info_2" class="control-label col-md-2 text-right">AppID：</label>
                <div class="col-md-10">
                    <input type="text" placeholder="AppID" class="form-control" name="app_id" value="{{$info->app_id}}" id="info_2">
                </div>
            </div>
            <div class="form-group clearfix">
                <label for="info_3" class="control-label col-md-2 text-right">AppSecret：</label>
                <div class="col-md-10">
                    <input type="text" placeholder="AppSecret" name="secret" value="{{$info->secret}}" class="form-control" id="info_3">
                </div>
            </div>
            <div class="form-group clearfix">
                <label for="info_4" class="control-label col-md-2 text-right">商户号：</label>
                <div class="col-md-10">
                    <input type="text" placeholder="商户号" name="mch_id" value="{{$info->m_id}}" class="form-control" id="info_4">
                </div>
            </div>
            <div class="form-group clearfix">
                <label for="info_5" class="control-label col-md-2 text-right">ApiKey：</label>
                <div class="col-md-10">
                    <input type="text" placeholder="ApiKey" name="api_key" value="{{$info->api_key}}" class="form-control" id="info_5">
                </div>
            </div>
            <div class="form-group clearfix">
